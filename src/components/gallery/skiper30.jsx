  ...
  return (
    <main className="w-full bg-[#eee] text-black">
      ...
      <div
        ...
        <Column images={[images[0], images[1], images[2],images[12],images[16]]} y={y} />
        <Column images={[images[3], images[4], images[5],images[13],images[17]]} y={y2} />
        <Column images={[images[6], images[7], images[8],images[14],images[18]]} y={y3} />
        <Column images={[images[9], images[10], images[11],images[15],images[19]]} y={y4} />
      </div>
      {/* <div
